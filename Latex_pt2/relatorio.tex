...
\begin{figure}[!hbt]
		...
		\Vertex[x=3, y=-2]{V5}
                \Vertex[x=2, y=-5]{V6}
		\Edge[LabelOut= true, label= 3](V1)(V2)
		\Edge[LabelOut= true, label= 5](V1)(V3)
		\Edge[LabelOut= true, label= 7](V1)(V4)
		\Edge[LabelOut= true, label= 3](V2)(V4)
		\Edge[LabelOut= true, label= 1](V2)(V5)
		\Edge[LabelOut= true, label= 1](V3)(V4)
		\Edge[LabelOut= true, label= 2](V3)(V6)
		\Edge[LabelOut= true, label= 6](V4)(V6)
		\Edge[LabelOut= true, label= 1](V4)(V5)
		\Edge[LabelOut= true, label= 3](V5)(V6)
